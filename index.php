...
<img src="src/logo.png" alt="Paris" style="width:50%;">
    ...
    <input type="text"  placeholder="USERNAME" style="border-radius: 10px;"  >
    <input type="text"  placeholder="PASSWORD" style="border-radius: 10px;"  >
    
   <input type="submit" value="LOGIN" onclick="getVal()">

     <input type="submit" value="REGISTER" onclick="location.href='getid.html'" >
